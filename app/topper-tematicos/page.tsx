...
const page = seoPagesBySlug["topper-tematicos"];

export const metadata: Metadata = {
  title: page.title,
  description: page.description,
  keywords: page.keywords,
  alternates: { canonical: "https://caketoppercostarica.com/topper-tematicos" },
  openGraph: {
    title: page.title,
    description: page.description,
    url: "https://caketoppercostarica.com/topper-tematicos",
    type: "website",
    locale: "es_CR",
