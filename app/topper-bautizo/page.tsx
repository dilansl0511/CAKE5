...
const page = seoPagesBySlug["topper-bautizo"];

export const metadata: Metadata = {
  title: page.title,
  description: page.description,
  keywords: page.keywords,
  alternates: { canonical: "https://caketoppercostarica.com/topper-bautizo" },
  openGraph: {
    title: page.title,
    description: page.description,
    url: "https://caketoppercostarica.com/topper-bautizo",
    type: "website",
    locale: "es_CR",
