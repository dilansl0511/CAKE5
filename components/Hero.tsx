...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    items.forEach((item, i) => {
      (item as HTMLElement).style.animationDelay = `${i * 150}ms`;
      (item as HTMLElement).style.opacity = "0";
      (item as HTMLElement).style.animation = `fadeUp 0.8s ease-out ${i * 150}ms forwards`;
    });
  }, []);
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, #f4476e 0%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, #c9956c 0%, transparent 70%)",
            transform: "translate(-30%, 30%)",
          }}
        />
        {/* Dots pattern */}
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(#b5838d 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        {/* Eyebrow */}
        <p
          className="reveal inline-flex items-center gap-2 text-xs tracking-[0.35em] uppercase text-dusty font-sans mb-6 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-blush-100"
        >
        ...
        {/* Main title */}
        <h1
          className="reveal font-display text-5xl md:text-7xl font-bold leading-[1.1] mb-6"
          style={{ fontFamily: "var(--font-playfair)" }}
        >
          <span className="text-[#3d2a2a]">Cake Toppers</span>
          <br />
          <span className="text-gradient italic">Personalizados</span>
          <br />
          <span className="text-[#3d2a2a] text-4xl md:text-5xl">
            en Costa Rica
          </span>
        </h1>
        ...
        {/* Subtitle */}
        <p
          className="reveal font-body text-xl md:text-2xl text-[#3d2a2a]/65 mb-10 max-w-2xl mx-auto leading-relaxed"
          style={{ fontFamily: "var(--font-cormorant)" }}
        >
          El toque especial que hace memorable tu boda, cumpleaños,
          baby shower o graduación. Hechos con amor en Costa Rica. 🌺
        </p>
        ...
        {/* Stats */}
        <div className="reveal mt-16 flex flex-wrap justify-center gap-10">
          {[
